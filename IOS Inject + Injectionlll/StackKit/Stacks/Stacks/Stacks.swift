...
public extension UIView {
    ...
    @discardableResult
    func VStack(spacing: CGFloat = .zero,
                useSafeArea: Bool = true,
                @UIViewBuilder views: () -> [UIView]) -> UIStackView {
        return createStack(.vertical,
                           views: views(),
                           spacing: spacing,
                           alignment: .fill,
                           distribution: .fill,
    ...
    @discardableResult
    func HStack(spacing: CGFloat = .zero,
                useSafeArea: Bool = true,
                @UIViewBuilder views: () -> [UIView]) -> UIStackView {
        return createStack(.horizontal,
                           views: views(),
                           spacing: spacing,
                           alignment: .fill,
                           distribution: .fill,
...
public extension UIStackView {
    ...
    @discardableResult
    func marginTop(_ top: CGFloat) -> UIStackView {
    ...
    @discardableResult
    func marginLeft(_ left: CGFloat) -> UIStackView {
    ...
    @discardableResult
    func marginRight(_ right: CGFloat) -> UIStackView {
    ...
    @discardableResult
    func marginBottom(_ bottom: CGFloat) -> UIStackView {
